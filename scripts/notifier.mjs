...
export function buildNotificationPrompt(job) {
  ...
  return [
    ...
    "",
    "_This automatic local notification was generated by Codex Process Jobs. It contains no process output, and Codex can inspect the saved result on request._",
    "",
    "<!-- codex-process-jobs:notification",
    "Agent instruction: acknowledge the completion in one short sentence and mention that you can inspect the saved result.",
